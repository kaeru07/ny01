...
function normalizeTask(body: Record<string, unknown>, fallbackProjectId?: string): NewTaskInput | null {
  ...
  return {
    ...
    sourceRunId: typeof body.sourceRunId === 'string' ? body.sourceRunId.trim() : undefined,
    sourceType: typeof body.sourceType === 'string' ? body.sourceType as NewTaskInput['sourceType'] : undefined,
