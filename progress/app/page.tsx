      ...
      <section className="rounded-xl border-2 border-gray-900 bg-white p-3 dark:border-gray-100 dark:bg-gray-900">
        ...
        <dl className="mt-3 grid grid-cols-2 gap-2 text-sm">
          <div className="rounded-lg bg-gray-50 px-2.5 py-2 dark:bg-gray-800/60">
            ...
            <dd className="mt-0.5 line-clamp-2 text-xs font-semibold text-gray-900 dark:text-gray-100">{view.factoryOutlook.nowText}</dd>
          </div>
          <div className="rounded-lg bg-gray-50 px-2.5 py-2 dark:bg-gray-800/60">
            <dt className="text-xs font-semibold text-gray-400">次</dt>
            <dd className="mt-0.5 line-clamp-2 text-xs font-semibold text-gray-900 dark:text-gray-100">{autoQueue.next?.title ?? '実行可能なEpicなし'}</dd>
          </div>
          <div className="rounded-lg bg-gray-50 px-2.5 py-2 dark:bg-gray-800/60">
            <dt className="text-xs font-semibold text-gray-400">その次</dt>
            <dd className="mt-0.5 line-clamp-2 text-xs text-gray-700 dark:text-gray-200">{autoQueue.candidates[0]?.title ?? '候補整理中'}</dd>
          </div>
          <div className="rounded-lg bg-gray-50 px-2.5 py-2 dark:bg-gray-800/60">
            <dt className="text-xs font-semibold text-gray-400">待機</dt>
            <dd className="mt-0.5 text-xs text-gray-700 dark:text-gray-200">{view.factoryOutlook.waitingCount}件</dd>
          </div>
          <div className="rounded-lg bg-gray-50 px-2.5 py-2 dark:bg-gray-800/60">
            <dt className="text-xs font-semibold text-gray-400">前回</dt>
            <dd className="mt-0.5 line-clamp-2 text-xs text-gray-700 dark:text-gray-200">{view.factoryOutlook.previousText}</dd>
          </div>
          <div className="rounded-lg bg-gray-50 px-2.5 py-2 dark:bg-gray-800/60">
            <dt className="text-xs font-semibold text-gray-400">次回</dt>
            <dd className="mt-0.5 text-xs font-semibold text-gray-900 dark:text-gray-100">{view.factoryOutlook.nextRunText}</dd>
          </div>
        </dl>
      ...
      <section className="rounded-xl border border-gray-200 bg-white p-3 dark:border-gray-800 dark:bg-gray-900">
        ...
        <ul className="mt-3 grid grid-cols-2 gap-2">
          {view.projectProgress.slice(0, 3).map((p) => (
            <li key={p.id} className="rounded-lg bg-gray-50 p-2.5 dark:bg-gray-800/50">
              <div className="flex items-start justify-between gap-3">
                <p className="line-clamp-2 min-w-0 text-xs font-bold leading-snug text-gray-900 dark:text-gray-100">{p.name}</p>
                <p className="shrink-0 text-base font-bold text-gray-900 dark:text-gray-100">{p.progressPct}%</p>
              </div>
      ...
      <section className="rounded-xl border border-gray-200 bg-white p-3 dark:border-gray-800 dark:bg-gray-900">
        ...
        <ul className="mt-3 grid grid-cols-2 gap-2">
          {view.goalProgress.slice(0, 3).map((g) => (
            <li key={g.id} className="rounded-lg bg-gray-50 p-2.5 dark:bg-gray-800/50">
              <div className="flex items-start justify-between gap-3">
                <p className="line-clamp-2 min-w-0 text-xs font-bold leading-snug text-gray-900 dark:text-gray-100">{g.title}</p>
                <p className="shrink-0 text-base font-bold text-gray-900 dark:text-gray-100">{g.achievementPct}%</p>
              </div>
              <dl className="mt-2 space-y-1 text-[11px]">
                <div className="flex gap-2">
                  <dt className="w-12 shrink-0 text-gray-400">現在地</dt>
                ...
                <div className="flex gap-2">
                  <dt className="w-12 shrink-0 text-gray-400">根拠</dt>
