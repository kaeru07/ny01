...
export default async function AppDecisionsPage() {
  const [decisions, approvals, apps] = await Promise.all([
  ...
  return (
    <main className="space-y-4 px-4 pb-6 pt-4">
      <PageGuide
        title="承認・方針決定歴"
        guide="アプリ概要承認、既存アプリ仕様承認、アプリ由来の方針決定を新しい順に確認します。"
      />
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-3 dark:border-gray-800 dark:bg-gray-950">
        <p className="text-xs font-bold text-gray-500 dark:text-gray-400">履歴</p>
