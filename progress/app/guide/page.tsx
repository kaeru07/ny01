...
const FAQ: Array<{ q: string; a: string }> = [
  ...
  { q: '下タブ（メニュー）の構成は？', a: 'iPhoneの下タブは ホーム / ToDo / Project / 目標 / 自動実行 / その他 の6つです。「自動実行」がAI工場の自動実行キューで、ここから作業予約（Prompt Queue）と実行履歴にも行けます。Revenue・運用ガイド・作業予約・旧画面は「その他」（Legacy）から開けます。', },
