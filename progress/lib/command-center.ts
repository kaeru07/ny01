...
export const TERMS: Record<string, { ja: string; help: string }> = {
  ...
  appReviewFields: { ja: '審査提出準備', help: 'App Store審査でApp Store Connectに入力する価格・著作権・カテゴリ・プライバシーポリシー/サポートURL・説明文などを、アプリ別にコピペ用としてまとめた画面です。fastlane/metadata と apps.json を正本に表示し、価格・年齢レーティング・App Privacy はガイダンス値なので提出前に人が最終確認します' },
